<template>
  <div class="page-container">
    <el-divider content-position="left">审核作业清单</el-divider>
    ...
    <div class="clearfix" />
    <el-divider content-position="left">最新异常规则清单</el-divider>
    <div class="filter-container">
    ...
    <el-table ref="table2" v-loading="tableLoading2" :data="tableData2" row-key="id" stripe highlight-current-row class="width-100">
      ...
      <el-table-column prop="zdbm" label="异常数据编号" align="center" min-width="100" />
    ...
    <el-button slot="trigger" size="small" type="primary">导出异常数据</el-button>
    <el-button slot="trigger" size="small" type="primary">导出全量数据</el-button>
    <el-button slot="trigger" size="small" type="primary">提交审批</el-button>
...
import { fetchList1, fetchList2 } from '@/api/demo/data-audit'
