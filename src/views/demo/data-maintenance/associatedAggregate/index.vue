<template>
  <div class="page-container">
    ...
    <div class="clearfix" />
    <el-divider content-position="left">非底层资产持仓信息</el-divider>
    <div class="filter-container">
      <el-form ref="form2" :model="filter2" :rules="rules2" class="form-container" @submit.native.prevent>
        <el-row :gutter="10">
          <el-col :xs="24" :sm="12" :md="8">
            <el-form-item label-width="120px" label="非底层资产编号:" prop="a">
              <el-input v-model="filter2.a" :placeholder="'请输入非底层资产编号'" clearable />
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="8">
            <el-form-item label-width="120px" label="非底层资产名称:" prop="b">
              <el-input v-model="filter2.b" :placeholder="'请输入非底层资产名称'" clearable />
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="8" class="float-right">
    ...
    <el-table ref="table2" v-loading="tableLoading2" :data="tableData2" row-key="id" stripe highlight-current-row class="width-100">
      ...
      <el-table-column prop="a" label="非底层资产编号" align="center" min-width="130" />
      <el-table-column prop="b" label="非底层资产名称" align="center" min-width="130" />
      <el-table-column prop="c" label="基础资产类型" align="center" min-width="130" />
      <el-table-column prop="d" label="基础资产持仓比例" align="center" min-width="130" />
    </el-table>
...
import { fetchList1, fetchList2 } from '@/api/demo/data-maintenance/importantAssociated'
