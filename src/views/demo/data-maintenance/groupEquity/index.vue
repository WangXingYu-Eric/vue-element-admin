  ...
  <div class="page-container">
    ...
    <div class="filter-container">
      <el-form ref="form2" :model="filter2" :rules="rules2" class="form-container" @submit.native.prevent>
        <el-row :gutter="10">
          <el-col :xs="24" :sm="12" :md="8">
            <el-form-item label-width="100px" label="股东名称:" prop="name">
              <el-input v-model="filter2.name" :placeholder="'请输入股东名称'" clearable />
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="8">
            <el-form-item label-width="120px" label="股东所属行业:" prop="code">
              <el-input v-model="filter2.code" :placeholder="'请输入股东所属行业'" clearable />
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="8">
            <el-form-item label-width="120px" label="股东证件类别:" prop="cardType">
              <el-select v-model="filter2.zjlb" :placeholder="'请选择证件类型'" clearable class="width-100">
          ...
          <el-col :xs="24" :sm="12" :md="8">
            <el-form-item label-width="120px" label="股东证件号码:" prop="cardNo">
              <el-input v-model="filter2.zjhm" :placeholder="'请输入证件号码'" clearable />
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="8" class="float-right">
    ...
    <el-table ref="table2" v-loading="tableLoading2" :data="tableData2" row-key="id" stripe highlight-current-row class="width-100">
      ...
      <el-table-column prop="name" label="股东名称" align="center" min-width="130" />
      <el-table-column prop="code" label="股东所属行业" align="center" min-width="130" />
      <el-table-column prop="zjlb" label="股东证件类别" align="center" min-width="130" />
      <el-table-column prop="zjhm" label="股东证件号码" align="center" min-width="130" />
      <el-table-column prop="gdzt" label="股东状态" align="center" min-width="130" />
      <el-table-column prop="gdcze" label="股东出资额" align="center" min-width="130" />
      <el-table-column prop="endTime" label="股东入股日期" align="center" min-width="130" />
      <el-table-column prop="gddz" label="股东地址" align="center" min-width="130" />
      <el-table-column prop="cgbl" label="持股比例" align="center" min-width="130" />
      <el-table-column prop="qt" label="投资其他金融机构标志" align="center" min-width="130" />
    </el-table>
...
import { fetchList1, fetchList2 } from '@/api/demo/data-maintenance/groupEquity'
